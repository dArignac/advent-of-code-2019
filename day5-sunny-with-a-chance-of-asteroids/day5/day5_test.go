...
func TestFixIntcodeProgramCodeNoop(t *testing.T) {
	code := []int{99}
	output := []int{7}
...
func TestFixIntcodeProgramCodeAddition(t *testing.T) {
	output := []int{}
...
func TestFixIntcodeProgramCodeMultiplication(t *testing.T) {
	output := []int{}
	code := []int{2, 3, 0, 3, 99}
